...
-- To prove that we have only single contract fro each employee
...
/*
   4. Create an SQL stored procedure that will allow you to obtain 
   ...
   Imagine your boss has just told you ' There have not been many people who have earned less than 50,000$ or more than 90,000$'.
 */
